...
export default function Table({ session }: { session: Session | null }){
    ...
    const listFiles = todos.map(file =>
        <tr key={file.id} className='bg-blur-sm text-center text-zinc-400 transition ease hover:text-white hover:bg-purple-700/[0.1] duration-500 border-b-2 border-neutral-100/30'>
